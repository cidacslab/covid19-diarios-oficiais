...
class Embeddings:
    ...
    def get_top_k(self, word, k):
        ...
        # sort similarities
        sorted_word_similarities = sorted(
            word_similarities, key=lambda k: k[1], reverse=True)
        # return top k
    ...
    def generate_mwu(self, search_obj):
        ...
        filtered_words = [
            w for w in all_words if search_obj.get_term_freq(w) > 0]
        print(
        ...
        for word1 in filtered_words:
            ...
            for word2 in filtered_words:
                ...
                if score > 0:
                    print(
                        f'testind word:<{word1}> and word<{word2}>, the score is:<{score}>')
